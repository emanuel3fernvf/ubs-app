...
return [
    ...
    'patient' => [
        'success' => [
            ...
            'create' => 'Paciente salvo com sucesso.',
            'update' => 'Paciente atualizado com sucesso.',
        ],
        'error' => [
            'delete' => 'Erro ao remover o paciente.',
            'create' => 'Erro ao salvar o paciente.',
            'update' => 'Erro ao atualizar o paciente.',
            'find' => 'Erro ao mostrar o paciente.',
        ],
        'confirmation' => [
